...
```{r, echo = FALSE}
## LOAD ALL .CSV FILES
path_csv <- "C:/Users/Matthias/Documents/GithubRepos/CIEB/innovation-origins/Report"
...
p <- ggplot(plot_data)+
  geom_area(aes(x = p_year, y = - a + number / b, fill = Type), alpha = 0.7)+
  ...
  scale_y_continuous("Share of Swiss patents by cross-border commuters",
                     sec.axis = sec_axis(~ (. + a) * b, #name = "Number of patents"))+#,
                                        guide = "none")) +
  xlab("Year") +
