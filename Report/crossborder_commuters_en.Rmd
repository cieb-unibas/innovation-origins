...
<!-- #                    label = "", -->
<!-- #                    icon = icon("xing"), -->
<!-- #                    onclick = sprintf("window.open('%s')", "https://www.xing.com/spi/shares/new?url=https://innoscape.ch/en/publications/cross-border-commuting-and-inventions-made-in-switzerland")) -->
...
<!-- #  -->
<!-- # actionButton("mail_share", -->
<!-- #                    label = "", -->
<!-- #                    icon = icon("envelope"), -->
<!-- #                    onclick = sprintf("window.open('%s')", "mailto:info@example.com?&subject=&body=https://innoscape.ch/en/publications/cross-border-commuting-and-inventions-made-in-switzerland")) -->
<!-- # ``` -->
